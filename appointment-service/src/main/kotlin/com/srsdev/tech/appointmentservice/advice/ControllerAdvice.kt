package com.srsdev.tech.appointmentservice.advice

//import com.srsdev.tech.appointmentservice.exception.DatabaseRepositoryException
...
class ControllerAdvice {
    ...
    @ExceptionHandler
    fun handleDuplicateEntryException(exception: DuplicateEntryException): String {
        return exception.message.toString()
    }
